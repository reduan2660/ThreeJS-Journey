...
const tick = () => {
  ...
  ghost3.position.x = Math.cos(ghost3Angle) * 4 + Math.sin(ghost2Angle * 0.32);
  ghost3.position.z = Math.sin(ghost3Angle) * 4 + Math.sin(ghost2Angle * 1);
  ghost3.position.y = Math.sin(ghost3Angle) * 3 + Math.sin(ghost2Angle * 0.1);
